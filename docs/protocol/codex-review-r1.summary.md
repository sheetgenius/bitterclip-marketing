...
- Instagram connect copy overpromises; the product path is Meta/Facebook Page + professional account constrained and capped.
- MCP docs/data need tightening: `open_workspace` is the real opener, and the curated tool list has incomplete workflows.
