    ...
    <section id="how" class="btf relative mx-auto max-w-6xl scroll-mt-28 px-6 sm:px-8">
      ...
      <figure class="mt-10 md:mt-14">
        <div class="agent-card overflow-hidden rounded-2xl border">
          <DeferredImage src="/images/hero/sizzle-editor-5.webp" alt="The BitterClip editor mid-direction: the agent names the strongest beat at 0:55-1:10, the player plays that exact moment, the timeline holds the range selected and ready to become a clip, and the transcript shows the line it found - John asking why did we start doing this, and Mike answering that he decided to quit his job after 12 years" class="block w-full" width="2560" height="1252" />
        </div>
