...
<template>
  <main class="relative left-1/2 w-screen -translate-x-1/2 overflow-hidden bg-[#08090a] pb-16">
    <div class="relative h-[100svh] min-h-[640px] w-full md:h-[86vh] md:min-h-[560px]">
      ...
      <div class="relative mx-auto flex h-full max-w-6xl flex-col px-6 pt-8 sm:px-8 md:-translate-y-[3.5vh] md:justify-center md:pt-0">
