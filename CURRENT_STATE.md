...
- Docs Markdown twins, docs entries in `llms.txt` and `llms-full.txt`, sitemap
  ...
  `bun run generate`.
- `contracts/mcp/` authors all 112 public tool contracts at commit
  `ea83fe87705c46f0a5ba14d1d30246974610151e`, digest
  `01c1852a25414643405925d3efc90ca8096b39bd4ddf8f259254e6395c8fe3ef`.
  The product pin selects that snapshot. Each static build validates the
