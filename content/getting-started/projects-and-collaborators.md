...
description: What a project is, how to switch between projects, and how to invite an editor, reviewer, or client to work alongside you.
navigation:
...
1. Open the project you want to share and go to its invitations page.
2. Send an invite to your collaborator's email address, and pick their role.
3. They get an invite link. Their email arrives if delivery is set up, but the link is what matters, so you can also send it to them yourself.
4. They open the link and accept.
...
::callout{type="note"}
A new collaborator sets a password when they accept, which creates their own account. If they already have a BitterClip account, they sign in with the invited email first. Either way it's quick, and they don't need a paid plan to join you.
::
...
::callout{type="tip"}
A clip a collaborator makes is still tied back to the original recording it came from, so it's easy to see where it started and find the full context later.
::
...
links:
  ...
  - to: /docs/assistants/connect-chatgpt
    label: Use it from ChatGPT
  - to: /docs/assistants/connect-claude
    label: Use it from Claude
---
::
