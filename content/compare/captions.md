---
title: "BitterClip vs Captions: Finish What You Actually Recorded"
...
rows:
  ...
  - axis: Cutting out a rambling answer
    bitterclip:
      ...
      detail: Select the sentence in the transcript, delete it, and the cut lands on the word.
    competitor:
      lead: No editing by transcript.
      detail: You correct caption wording phrase by phrase in a side panel; the video isn't cut from it.
    edge: bitterclip
  ...
  - axis: Two or three cameras on one conversation
    ...
    competitor:
      ...
      detail: AI Edit requires single-speaker unedited video, and no multicam appears in the docs.
    edge: bitterclip
  - axis: Working at a desk rather than on a phone
    bitterclip:
      lead: Same editor everywhere.
      detail: It runs in any browser with nothing to install, and it works from a phone browser.
    competitor:
      lead: The iPhone app is the product.
      detail: Their own docs list what web is missing — manual trimming, text, keyframes, transitions.
    edge: bitterclip
  - axis: A styled vertical clip in the next ten minutes
    bitterclip:
      lead: One tap for the vertical.
      detail: Any landscape cut gets a 9:16 version with captions and timing carried across.
    competitor:
      lead: Posted before you've decided.
      detail: Short single-speaker vertical footage comes back styled with almost no manual work.
    edge: competitor
  - axis: Wanting a presenter you never filmed
    bitterclip:
      lead: Only footage you recorded.
      detail: BitterClip doesn't generate presenters, and no mystery score picks your moments either.
    competitor:
  ...
  - axis: What the monthly bill looks like
    bitterclip:
      ...
      detail: Creator is $1 today for seven days, then $24/month; paid Creator includes 10 source-footage hours and $10 of included agent work.
    competitor:
      lead: Credits burn per feature.
      detail: Max is $24.99 for 500 credits, and unused credits are forfeited when you cancel.
    edge: even
chooseUs:
  - Your recordings are real sessions — a podcast episode, a coaching call, a workshop — and each one needs a full cut and a few vertical clips.
...
gotchas:
  - title: Cancel or downgrade and your credits are gone
    body: Captions' help docs say it plainly. On downgrade, "Balance is immediately reduced to the new plan's cap. Any excess credits are forfeited." On cancellation, "All remaining credits are forfeited at the end of the billing period." Rollover caps at three times your monthly allowance.
    sourceLabel: Captions help — AI usage and credits
    sourceUrl: https://captions.ai/help/docs/ai-usage
  - title: The prices you see are the iPhone prices
    body: "The fine print on Captions' own pricing page reads \"Features and prices reflect iOS plans only.\" Their feature-availability docs list what the web editor is missing: manual trimming, text, keyframes, and transitions, among other tools."
    sourceLabel: Captions pricing page (fine print)
    sourceUrl: https://www.captions.ai/pricing
  - title: The license you grant covers what you upload and what comes out
    body: You keep ownership of your content — and you grant Mirage a royalty-free, sublicensable license to host, reproduce, modify, and create derivative works from both your input and your output, scoped "to provide the Services, to improve the Services, and to develop new services and products." The license survives termination of the terms.
    sourceLabel: Captions Terms of Service, section 2.2
    sourceUrl: https://mirage.app/legal/captions-terms
  - title: Your footage can train their models unless you're on Enterprise
    body: Mirage's privacy policy states user information is used to "train our artificial intelligence/machine learning models," and describes no self-serve opt-out. Training-data exclusion appears on the pricing page as an Enterprise plan feature.
    sourceLabel: Mirage privacy policy
...
faq:
  ...
  - q: Which is more affordable, BitterClip or Captions?
    a: They charge for different things, so price it against what you actually make. BitterClip Creator is $1 today for a card-required seven-day trial, then $24/month unless canceled before the seven days end; paid Creator includes 10 source-footage hours and $10 of included agent work. Producer is $99/month with 40 source-footage hours, $40 of included agent work, and priority rendering. Captions' Max plan is $24.99 for 500 credits that burn per feature use; its free plan has no watermark but limits you to basic tools, and unused credits are forfeited when you cancel.
sources:
  - label: Captions pricing page
    url: https://www.captions.ai/pricing
  - label: Captions help — AI usage and credits
    url: https://captions.ai/help/docs/ai-usage
  - label: Captions help — AI Edit requirements and limits
    url: https://captions.ai/help/docs/project/ai-edit
  - label: Captions help — feature availability by platform
    url: https://captions.ai/help/docs/feature-availability
  - label: Captions help — editing caption spelling
    url: https://captions.ai/help/docs/captions/edit-spelling
  - label: Captions help — subscriptions and plans
    url: https://captions.ai/help/docs/subscriptions
  - label: Captions help — API overview
  ...
  - label: Introducing Mirage — Captions rebrand announcement
    url: https://captions.ai/blog/introducing-mirage-the-future-video-starts-now
---

## The day your recording stops fitting
