...
rows:
  - axis: What you can actually bring in
    bitterclip:
      ...
      detail: Footage from a phone, Zoom, Riverside, or a camera — or record camera and mic in the browser.
    competitor:
  ...
  - axis: When the first cut is wrong
    ...
    competitor:
      lead: Fix it by hand.
      detail: Trim the timeline, redo the captions, change the hook title — one change at a time.
    edge: bitterclip
  - axis: Editing by asking instead of clicking
    ...
    competitor:
      lead: Pipelines, not conversation.
      detail: Automation means Zapier, Make, n8n, and a REST API — no chat editing advertised.
    edge: bitterclip
  ...
  - axis: Who decides which moments are good
    ...
    competitor:
      ...
      detail: "Magic Clips pulls 20+ highlights per long video: $19 a month, 10 videos, 10–25 minutes each."
    edge: even
  - axis: Making the captions look right
    bitterclip:
      lead: Right words, your look.
      detail: Active-word highlight, placement, accent color, and per-word fixes when a name gets misheard.
    competitor:
  ...
  - axis: Getting it out the door
    ...
    competitor:
      lead: Five platforms, scheduled.
      detail: TikTok, YouTube, Instagram, Facebook, and LinkedIn straight from the app — wider reach than BitterClip today.
    edge: competitor
...
chooseThem:
  ...
  - You'd rather pick a caption look off the shelf than build one yourself.
  - You post to TikTok, Instagram, Facebook, LinkedIn, and YouTube and want to schedule all five from one place.
  - "You run no-code pipelines: Zapier, Make, or n8n dropping raw footage in one end and posts out the other."
  - You need seats for a team — three on Pro, unlimited on Business.
gotchas:
  ...
  - title: What happens to your projects if you cancel
    ...
    sourceLabel: Submagic Terms of Use
    sourceUrl: https://www.submagic.co/terms-of-use
  - title: Clipping long videos is a second subscription
    body: Magic Clips — the feature that turns long videos into shorts — isn't included in any base plan. It's $19 a month on top, and it covers 10 long videos a month.
    sourceLabel: Submagic pricing
...
faq:
  ...
  - q: Does BitterClip record?
    a: "Yes. Every project has a browser recorder: Record in browser on the Sources tab, or Record here in the editor's insert sheet, where the finished take drops into the edit at the playhead. It captures camera and mic from a laptop or phone browser, or your screen in desktop Chrome, up to 1080p, and it uploads in short chunks while you record, so transcription starts the moment you press stop. The boundary matters: one person, one device, signed in. There are no remote guests, no guest recording links, and no separate per-participant tracks — one session is one merged file. For recording a guest over the internet, a dedicated remote-recording tool is still the better choice. Submagic doesn't record at all."
...
sources:
  ...
  - label: Submagic pricing
    url: https://www.submagic.co/pricing
  - label: Submagic Terms of Use
    url: https://www.submagic.co/terms-of-use
  - label: Submagic integrations page
    url: https://www.submagic.co/integrations
  - label: Submagic v2 step-by-step guide (help center)
    url: https://care.submagic.co/en/article/how-to-use-submagic-v2-step-by-step-guide-pafx7o/
  - label: Magic Clips step-by-step guide (help center)
    url: https://care.submagic.co/en/article/how-to-use-magic-clips-step-by-step-guide-15mve5q/
  - label: Submagic free trial terms (help center)
    url: https://care.submagic.co/en/article/does-submagic-have-a-free-trial-7opyg3/
---

## You didn't record a clip. You recorded a conversation.

That is usually the whole problem. There are 90 minutes of a podcast, a client session, or a founder call sitting on a drive, and what you need out of it is one finished episode and four or five verticals. Submagic starts one step after that. It takes a piece of footage and makes it look good — template captions, emoji, zooms, B-roll, a hook title. Its own help center describes the workflow plainly: upload, style, correct, export. For a clip under two minutes, that really is the fastest way to something you'd post.

The catch is how much you're allowed to bring in. Starter caps a video at 2 minutes, Pro at 5, Business at 30. Turning a long recording into shorts is Magic Clips, a separate $19 a month that hands you a batch of machine-picked highlights, 10 long videos a month.
...
You can also skip the drop and record straight into the project. Every project has a browser recorder: Record in browser on the Sources tab, or Record here in the editor's insert sheet, which lands the finished take in the edit at the playhead. Prop your phone up and go — it takes camera and mic from a laptop or phone browser, or your screen in desktop Chrome, up to 1080p, and it uploads in short chunks while you record rather than leaving a big file on your device, so the take is transcribed by the time you press stop. Know the shape of it: one person, one device, signed in, with no remote guests and no guest recording links. For recording a guest over the internet, a dedicated remote-recording tool is still the better choice. Submagic doesn't record at all — it styles footage you already have.

## A template can read the text. It can't hear the point.

It doesn't know that "forty percent" is the number the whole clip exists to deliver, so the emphasis lands wherever the template's rules put it. Submagic gives you real tools to fix that — its guide walks through correcting transcript errors and moving word highlights and emoji — but the fixing is yours, caption by caption, clip by clip.

In BitterClip, captions are something you can ask for. Tell ChatGPT to highlight the price and the deadline and fix the founder's name everywhere it got misheard, and that is what happens: active-word highlight, accent color, placement, per-word corrections. Anything you can click, you can ask for — in ChatGPT, in Claude, or right in the editor.
