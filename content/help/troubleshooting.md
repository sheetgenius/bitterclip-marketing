...
description: The most common snags people hit with BitterClip, each with a quick fix.
navigation:
...
::callout{type="tip"}
If you signed up with Google, your email is already verified, since Google has confirmed your address.
::
...
You don't have to sit and wait. Finished clips land in your project's Outputs tab, so check there when you come back and it'll show as ready once the cut is done. See [Find and share your clips](/docs/getting-started/find-and-share-clips) for where to look.
...
The full walkthrough is in [Connect YouTube](/docs/connect/youtube).
...
::instagram-capped-note
::

For the full picture, see [Connect Instagram](/docs/connect/instagram).
