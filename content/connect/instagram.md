...
description: What the Connect Instagram button does today, and the dependable way to get your clips onto Instagram right now.
navigation:
  label: Instagram
  order: 4
section: connect
...
::callout{type="note"}
You post Reels from the Instagram app on your phone, so the clip has to live on your phone first. If you exported on a computer, move the file over before the next step.
::

4. Save the video to your phone's camera roll.
5. Open the Instagram app and start a new Reel or post.
6. Pick the clip from your camera roll, add your caption, and share.
