# BitterClip Terms Of Service

Canonical HTML page: https://bitterclip.com/terms
...
You must use BitterClip only for lawful purposes and only with content,
accounts, and integrations you have the right to use.

You are responsible for the activity that happens through your account,
workspace, connected publishing channels, and API or connector access tokens.

## Accounts And Access

You must provide accurate account information and keep your sign-in credentials
and connector tokens secure.
...
You retain your rights in recordings, transcripts, clips, exports, show
...
You are responsible for obtaining any permissions, releases, licenses, or
consents required for the people, media, music, trademarks, and other material
in your content.

## Publishing Integrations

BitterClip can connect to services such as YouTube, LinkedIn, and X after an
account owner or admin authorizes the integration.

Publishing actions may upload media, create posts, refresh OAuth access, and
store publishing receipts for the connected account.
...
Do not use BitterClip to infringe rights, violate privacy, harass people,
distribute malware, bypass platform rules, spam, scrape, overload systems, or
publish unlawful or harmful material.

Do not attempt to reverse engineer, probe, attack, resell, sublicense, or misuse
...
BitterClip is provided as is and as available, without warranties of
...
We may update these terms as BitterClip changes. The effective date above shows
when this version became active.

## Privacy

BitterClip's privacy policy explains how we handle information across the
website, app, connectors, and publishing integrations:
https://bitterclip.com/privacy
